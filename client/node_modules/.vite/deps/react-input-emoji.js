...
function useExpose(_ref) {
  ...
  var _useSanitize = useSanitize(), sanitize = _useSanitize.sanitize, sanitizedTextRef = _useSanitize.sanitizedTextRef;
...
function EmojiPickerButton(_ref) {
  var showPicker = _ref.showPicker, toggleShowPicker = _ref.toggleShowPicker, buttonElement = _ref.buttonElement;
...
function EmojiPicker(props) {
  var theme = props.theme, onSelectEmoji = props.onSelectEmoji, disableRecent = props.disableRecent, customEmojis = props.customEmojis;
...
EmojiPicker.propTypes = {
  theme: import_prop_types.default.oneOf(["light", "dark", "auto"]),
  onSelectEmoji: import_prop_types.default.func,
  disableRecent: import_prop_types.default.bool,
  customEmojis: import_prop_types.default.array
};
var EmojiPicker$1 = (0, import_react.memo)(EmojiPicker);
function EmojiPickerContainer(_ref) {
  var showPicker = _ref.showPicker, theme = _ref.theme, handleSelectEmoji = _ref.handleSelectEmoji, disableRecent = _ref.disableRecent, customEmojis = _ref.customEmojis;
  return import_react.default.createElement("div", {
...
var EmojiPickerWrapper = function EmojiPickerWrapper2(props) {
  var theme = props.theme, keepOpened = props.keepOpened, disableRecent = props.disableRecent, customEmojis = props.customEmojis, addSanitizeFn = props.addSanitizeFn, addPolluteFn = props.addPolluteFn, appendContent = props.appendContent, buttonElement = props.buttonElement;
...
function useMention(searchMention) {
  ...
  var onKeyUp = (0, import_react.useCallback)(function() {
...
MentionUserListWithRef.propTypes = {
  users: import_prop_types.default.array.isRequired
};
...
function InputEmoji(props, ref) {
  ...
  var setValue = (0, import_react.useCallback)(function(value2) {
    updateHTML(value2);
  }, [updateHTML]);
...
react-input-emoji/dist/index.es.js:
